...
<div class='col-xs-8'>
	<form >
		...
		<label for="cedula">Cédula de usuario a modificar</label><input id="cedula" class="form-control" type="text" name="cedula" placeholder=" inserte número de cédula" required>
...
<script type="text/javascript">
	$("document").ready(function(){
				...
				$("#bot").click(function(){
					...
					$.get("../../C/con_validar_usuario.php",{param_id:cedula,usua:usuario})
					.done(function(data){
						$("#usu").html(data);
					})
				})
